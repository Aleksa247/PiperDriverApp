...
class LocationTracker(
    ...
    suspend fun getCurrentLocation(): Pair<Double, Double>? = try {
     ...
     */
    @SuppressLint("MissingPermission")
    private suspend fun getNewLocationWithRequest(locationRequest: LocationRequest): Pair<Double, Double>? = try {
